...
public class Dog extends Animal {
	...
	public Dog(final String name, final String species, final int age, final String breed) throws PositiveValueRequiredException, AnimalBreedException, EmptyValueException, TooShortValueException, NameFormatException {
